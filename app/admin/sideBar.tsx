  ...
  return (
    <div className='bg-gray-100 w-[20%]'>
      <div className=' text-gray-700 flex flex-col  rounded-l-2xl p-3 pr-6  '>
        ...
        <div className='flex items-center gap-2 p-3 mb-12  absolute bottom-0 border-2  border-red-400 rounded-lg  hover:text-gray-700  hover:bg-red-400 cursor-pointer transition duration-300'>
